  ...
  return (
    <footer id="site-footer" className="mt-10 md:mx-10 p-10 rounded-t-[3rem] md:rounded-t-[5rem] border-2 border-b-8 border-fcolor">
      ...
      <div>
        ...
        <Link href={"https://www.linkedin.com/in/yug-prajapati-70524926b/"} target="_blank" className="flex justify-between items-baseline py-5 md:py-8 md:mx-32 hover:px-10 border-b-2 border-black">
