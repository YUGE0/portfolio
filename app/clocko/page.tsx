  ...
  return (
    <div className="mx-1 md:mx-10 mb-10 rounded-[3rem] border-2 border-[#2A4064]">
      ...
      <div className="md:p-16">
        ...
        <div className="flex flex-wrap 2xl:flex-nowrap justify-around items-center">
          ...
          <div className="p-10 rounded-[3rem] bg-[#2A4064] text-white">
            ...
            <p className="text-md md:text-xl font-inter font-light text-balance">Seconds is a critical component requiring rendering at very brief intervals.</p>
            <h1 className="text-3xl font-medium font-inter">AM/PM</h1>
            <p className="text-md md:text-xl font-inter font-light text-balance">The 24-hour format is used, but having an AM/PM indicator can greatly help users quickly determine whether it is morning or afternoon, especially during scheduled meetings or when involved in lengthy projects.</p>
            <h1 className="mt-10 text-3xl font-medium font-inter">Learnings</h1>
            <p className="text-md md:text-xl font-inter font-light text-balance">The components are all in the Hours.JSX file. Rendering the hours and the am/pm indicator is quite easy, but rendering the seconds is a task that requires deeper thought. Using a timeout can work, 
        ...
        <div className="md:p-10 flex flex-wrap 2xl:flex-nowrap justify-around items-center">
          ...
          <div className="p-10 rounded-[3rem] bg-[#2A4064] text-white">
            ...
            <p className="text-md md:text-xl font-inter font-light text-balance">Maintaining the date in this manner is more meaningful than adhering to the conventional format. Presenting the date without the inclusion of the month and year offers a more concise and precise representation.</p>
            <h1 className="mt-10 text-3xl font-medium font-inter">Learnings</h1>
            <p className="text-md md:text-xl font-inter font-light text-balance">In this context, the emphasis lay in selecting the most suitable aesthetic for the application, while the developmental approaches remained consistent with earlier components. By delineating the day and date in a manner that distinguishes it, the website can be rendered more streamlined.
            </p>
          </div>
        </div>
        <div className="md:p-10 flex flex-wrap 2xl:flex-nowrap justify-around items-center">
          ...
          <div className="p-10 rounded-[3rem] bg-[#2A4064] text-white">
            ...
            <p className="text-md md:text-xl font-inter font-light text-balance">As a user can add any time, the web has all the information available on simple search. Therefore, they can get the UTC offset, and minor changes in the code will display the correct time.</p>
            <h1 className="text-3xl font-medium font-inter">AM/PM</h1>
            <p className="text-md md:text-xl font-inter font-light text-balance">The 24-hour format is used, but having an AM/PM indicator can greatly help users.This is particularly beneficial when navigating scheduled meetings in different time zones or when engaged in extensive projects.</p>
      ...
      <div className="mt-10 p-10 flex items-baseline flex-wrap justify-around rounded-b-[3rem] bg-[#2A4064]">
        ...
        <Link className="px-10 p-5 rounded-xl shadow-md text-lg font-work font-semibold bg-white hover:bg-black/70 hover:text-white" href="https://cl0cko.vercel.app/">Deployed site</Link>
        </div>
      </div>
    </div>
  )
