...
export default function WorkCom(prop:{project:string}) {
  return (
    <Link href={`/${prop.project}`} className="flex justify-between items-baseline m-10 md:m-20 hover:px-10 border-b-2 border-black">
        <h1 className="text-3xl md:text-5xl pb-5 md:pb-10 font-bold uppercase">{prop.project}</h1>
