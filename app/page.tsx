...
const skills: string[] = ["Nextjs","Reactjs","TailwindCSS"];
const skillst: string[] = ["TypeScript","JavaScript"];
const index = 1
...
export default function Home() {
  return (
    <div className="">
      ...
      <div className="p-4 sm:p-20 mb-8">
        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="p-2">
            {skillst.map((skill) => (<Skills key={index} skill={skill} />))}
          </div>  
        </div>
      </div>
    </div>
